...
namespace MVVMApp.ViewModels
{
    public class FriendsListViewModel : INotifyPropertyChanged
    {
        ...
        {
            // Использование методов IImagePicker для выбора изображения и получения пути
            string imagePath = await DependencyService.Get<IImagePicker>().GetImagePathAsync("fileName.jpg");
